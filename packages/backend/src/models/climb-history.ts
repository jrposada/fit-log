import type { ClimbHistoryStatus } from '@jrposada/fit-log-shared/models/climb-history/climb-history';
import { CLIMB_HISTORY_STATUSES } from '@jrposada/fit-log-shared/models/climb-history/climb-history';
